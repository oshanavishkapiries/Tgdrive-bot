...
async def _start(client, message):
    ...
    filename = None
    if message.text:
        sent_message = await message.reply_text("**Checking Link...**", reply_parameters=ReplyParameters(message_id=message.id))
        ...
        sent_message = await message.reply_text("📥 **Downloading File...**", reply_parameters=ReplyParameters(message_id=message.id))
        try:
